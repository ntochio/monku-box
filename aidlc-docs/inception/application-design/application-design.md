...
| GET | `/v1/api/messages` | 一覧（閲覧者以上、クエリで topic・期間） |
| GET/POST | `/v1/api/topics` | 一覧・追加 |
| GET | `/v1/api/dashboard/summary` | KPI・トレンド用集約 |
...
| 2026-05-08 | 要件確認書追記に整合：インフラ・通信標準は PoC で深く確定しない／JSON 中心・拡張しやすい境界（§1・§2・§8） |
